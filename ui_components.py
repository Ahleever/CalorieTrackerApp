...
class EntriesDisplay(tk.Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.grid_rowconfigure(3, weight=1) # Let the text box grow
...
class WeightGraph(tk.Frame):
    ...
    def __init__(self, master, **kwargs):
        super().__init__(master, bg="#ffffff", **kwargs)
        self.grid_columnconfigure(0, weight=1)
        self.grid_rowconfigure(1, weight=1) # Let the container grow
...
class SidebarFrame(tk.Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        # Configure the history list to take remaining space
    ...
    def _create_exercise_panel(self):
        ...
        self.history_row_index = len(recommendations) + 3 # Store for later grid config
