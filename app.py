...
class CalorieTrackerApp:
    ...
    def update_all_displays(self):
        ...
        # 2. Update Daily Entries and Total
    ...
    def show_main_tracker(self):
        ...
        # Top Horizontal Frame (Profile + Inputs)
        ...
        # --- Main Display Frame (Entries + Graph) ---
        ...
        display_frame.grid_rowconfigure(1, weight=1) # Entries Text row
        display_frame.grid_rowconfigure(3, weight=1) # Graph row

        # Entries Display Component
